...
#$FromAddress = $vCenterServerName + "@email.com"
$FromAddress = "vmware_capacity@email.com"
...
#http://www.shogan.com/vmware/generating-graphical-charts-with-vmware-powercli-powershell/
