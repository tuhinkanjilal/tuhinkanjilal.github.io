...
## VCenter Connection
$VCStatus = connect-VIServer $VCServer -User C4-SVC-VCENTER -password TaQa2ajU -ErrorAction SilentlyContinue -ErrorVariable ErrorProcess;
if($ErrorProcess){
...
-Body "Attached is the VMware Daily Report which will give you an overview of the VMWare Infra"  -SmtpServer $SMTPServer -Attachments $ReportExport\$VCServer-DailyReport.htm
