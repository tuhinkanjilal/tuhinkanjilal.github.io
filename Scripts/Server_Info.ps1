...
$users = "tk@abc.com" # List of users to email your report to (separate by comma)
$fromemail = "serverreport@abc.com"
$server = "smtp.abc.com" #enter your own SMTP server DNS name / IP address here
