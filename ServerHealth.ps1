...
$ServerList = Import-CSV "F:\Wintel\TUHIN\SCRIPT\Task_Scheduler\Server_Health\Server_Health\ServerList.csv" –Header Server #, Description
...
$EmailTo = "twhite@channel4.co.uk","vsharma@channel4.co.uk","CFGDatacentreSupport@channel4.co.uk"
#$EmailTo = "vsharma@channel4.co.uk","CFGDatacentreSupport@channel4.co.uk"
#$EmailTo = "tkanjilal@channel4.co.uk"
$EmailFrom = "ServerHealth@channel4.co.uk"
$EmailSubject = "Server Health Report for $DateStamp"
$EmailAttachment = "Yes"
