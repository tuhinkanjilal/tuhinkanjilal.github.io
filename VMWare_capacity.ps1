...
#-------------------------CHANGE THESE VALUES--------------------------------
$SMTPServer = "172.26.28.50"
$vCenterServerName = "vcenter.sddc-18-133-135-29.vmwarevmc.com"
$vCenterServerName = "dcr-v-vcsa01"
#$ToAddress = "rharding@email.co.uk","twhite@email.co.uk","vsharma@email.co.uk","CFGDatacentreSupport@email.co.uk","MArora@email.co.uk","SHKumar@email.co.uk"
$ToAddress = "tkanjilal@email.co.uk"
#$ToAddress = "destinationadress1@company.com", "destinationadress2@company.com", "destinationadress3@company.com"
#-----------------------------------------------------------------------------

$ScriptVersion = "v1.0 - email" # Included in the Runtime info in $HTMLFooter
$Subject = "VMware Capacity & Performance Report for " + $vCenterServerName
#$FromAddress = $vCenterServerName + "@email.co.uk"
$FromAddress = "vmware_capacity@email.co.uk"
...
Connect-VIServer -Server dcr-v-vcsa01 -User C4-SVC-VCENTER -Password 'TaQa2ajU'
