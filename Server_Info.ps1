...
$users = "tkanjilal@channel4.co.uk" # List of users to email your report to (separate by comma)
$fromemail = "serverreport@channel4.co.uk"
$server = "smtp.channel4.co.uk" #enter your own SMTP server DNS name / IP address here
